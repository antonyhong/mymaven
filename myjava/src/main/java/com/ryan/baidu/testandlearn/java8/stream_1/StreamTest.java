...
//        System.out.println(mapName2Stu);
    ...
    private static void test(){
       List<Student_inner> students =  Arrays.asList(
               new Student_inner("Tom",11),
               new Student_inner("Any",10),
               new Student_inner("Ryan",10),
               new Student_inner("Bob",16));
       Map<Integer, List<Student_inner>> map =  students.stream().collect(groupingBy(Student_inner::getAge,Collectors.toList()));
